...
- Al modificar cualquiera de los tres, sincronizar los otros dos **en la misma pasada**. El único contenido que puede diferir es el frontmatter YAML del `.mdc` (`alwaysApply: true`).
